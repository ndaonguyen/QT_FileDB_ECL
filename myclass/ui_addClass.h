...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        Form->resize(934, 667);
        classAdd1Widget = new QWidget(Form);
        ...
        regisDayLabel->raise();
        otherLineEdit->raise();
        courseInfoWidget = new QWidget(Form);
        courseInfoWidget->setObjectName(QString::fromUtf8("courseInfoWidget"));
        courseInfoWidget->setGeometry(QRect(480, 50, 411, 561));
        verticalLayoutWidget_4 = new QWidget(courseInfoWidget);
        verticalLayoutWidget_4->setObjectName(QString::fromUtf8("verticalLayoutWidget_4"));
        verticalLayoutWidget_4->setGeometry(QRect(10, 20, 401, 541));
        ...
        classAdd2Widget = new QWidget(Form);
        classAdd2Widget->setObjectName(QString::fromUtf8("classAdd2Widget"));
        classAdd2Widget->setGeometry(QRect(20, 260, 431, 241));
        ...
        classAdd3Widget = new QWidget(Form);
        classAdd3Widget->setObjectName(QString::fromUtf8("classAdd3Widget"));
        classAdd3Widget->setGeometry(QRect(20, 519, 431, 101));
        ...
        enableClass2Button = new QPushButton(Form);
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        otherLabel->setText(QApplication::translate("Form", "Note", 0, QApplication::UnicodeUTF8));
        totalDayLabel->setText(QApplication::translate("Form", "Total days", 0, QApplication::UnicodeUTF8));
        dayUseLabel->setText(QApplication::translate("Form", "Day use", 0, QApplication::UnicodeUTF8));
        classNameLabel->setText(QApplication::translate("Form", "Class name", 0, QApplication::UnicodeUTF8));
        regisDayLabel->setText(QApplication::translate("Form", "Registration day", 0, QApplication::UnicodeUTF8));
        otherLineEdit->setText(QString());
        groupBox->setTitle(QString());
        label_3->setText(QApplication::translate("Form", "Edit, delete or add member in table directly ", 0, QApplication::UnicodeUTF8));
        memberLabel->setText(QApplication::translate("Form", "Members", 0, QApplication::UnicodeUTF8));
        groupBox_2->setTitle(QString());
        courseClassLabel->setText(QString());
        chooseCourseLabel->setText(QApplication::translate("Form", "Choose course", 0, QApplication::UnicodeUTF8));
        groupBox_3->setTitle(QString());
        enableClass2Button->setText(QApplication::translate("Form", "Enable member edit", 0, QApplication::UnicodeUTF8));
        cancelButton->setText(QApplication::translate("Form", "CANCEL", 0, QApplication::UnicodeUTF8));
        courseInfoLabel->setText(QString());
        enableClass1Button->setText(QApplication::translate("Form", "Enable class info edit", 0, QApplication::UnicodeUTF8));
        saveButton_2->setText(QApplication::translate("Form", "SAVE", 0, QApplication::UnicodeUTF8));
        enableClass3Button->setText(QApplication::translate("Form", "Enable course edit", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
